...
//=============================================================================
 /*:
 * @plugindesc v1.07 This plugin gives the player more control over the Battle
 * Test
 * @author reccanti
 *
...
//=============================================================================
var BattleTest = {
    performAction: function (action, subject, target) {
...
BattleManager.setBattleTest = function(battleTest) {
    ...
    // disable the normal flow of battle
